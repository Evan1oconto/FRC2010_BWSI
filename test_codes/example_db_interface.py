...
test = DB(db_path="example_db.json")
test.init_db()
test.admin_create_account("1234567891011121", "625")
test.set_balance("1234567891011121", "1025")
print test.get_balance("1234567891011121")
